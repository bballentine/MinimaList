...
public class MinimalStyles : NSObject {
    ...
    private struct Cache {
        ...
        static let priorityHigh: UIColor = UIColor(red: 0.667, green: 0.667, blue: 0.667, alpha: 1.000)
        static let priorityMedium: UIColor = UIColor(red: 0.815, green: 0.815, blue: 0.815, alpha: 1.000)
